...
def test_backend_serves_distinct_revision_bound_admin_and_user_app_routes() -> None:
    ...
    assert "grep -Rqs 'CANONICAL_REACT_ADMIN' scripts/sovereign-backend/admin-dist" in workflow
    assert "grep -Rqs 'sovereign-release-chat' scripts/sovereign-backend/admin-dist" in workflow
    assert "grep -Rqs 'play-release-chat' scripts/sovereign-backend/admin-dist" in workflow
    assert "grep -Rqs 'Free Revolver' scripts/sovereign-backend/admin-dist" in workflow
