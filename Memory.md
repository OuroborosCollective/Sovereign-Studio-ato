...
Open: New current-main Draft PR needs terminal exact-head CI and merge readback.
Next safe step: Create the Draft PR, require terminal CI, then merge only the exact green head.
