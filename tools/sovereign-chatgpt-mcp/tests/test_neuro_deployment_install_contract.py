...
EXPECTED_CAG_TOOLS = {"evidence_observatory_cag_staging_publish"}
...
""",
    ...
    predecessor_registry["tools"] = [
        ...
        if item["name"] not in (EXPECTED_NEURO_TOOLS | EXPECTED_CAG_TOOLS)
    ]
    ...
    assert set(compatibility_receipt["additions"]) == (EXPECTED_NEURO_TOOLS | EXPECTED_CAG_TOOLS)
