...
- Ein fsync-gesicherter Claim im bestehenden root-only Verzeichnis `runtime-evidence` steht vor dem ersten Submit. Derselbe Submit liefert sein Receipt erneut. Ein unbekannter Ausgang, 2xx ohne Task-ID oder 5xx sperrt auch eine neue Operation. Bekannte Tasks werden ausschließlich gepollt. Ein neuer Versuch nach belegtem 3xx/4xx-Reject oder terminalem Task benötigt eine neue explizite Operation; automatische Retries gibt es nicht.
