...
n8n_workflow_tools.register(server.mcp, server.broker)
...
# Register Neuro/Teacher tools last so later module composition cannot shrink the canonical Neuro lane.
