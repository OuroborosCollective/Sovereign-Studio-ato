...
export class RuntimeIntelligence {
  ...
  /**
   * Offline diagnostic rule evaluation only.
   *
   * This method must never be used as the online chat/executor language authority.
   * Online natural-language intent comes from structured LLM evidence; this
   * legacy container grammar remains available only for degraded diagnostics.
   */
  decide(
    containerId: string,
    visibleText: string,
