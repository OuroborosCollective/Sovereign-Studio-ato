          ...
          <div className="space-y-5">
            <div className="group">
              ...
              <input
                ...
                value={repoUrl || ''}
                onChange={(e) => {
                  if (setRepoUrl) setRepoUrl(e.target.value);
                  if (handleRepoChange) handleRepoChange();
                }}
            ...
            <div className="group">
              ...
              <input
                type="password"
                value={ghPat || ''}
                onChange={(e) => handleGhPatChange && handleGhPatChange(e.target.value)}
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                placeholder="ghp_..."
              />
            </div>
            <div className="group">
              ...
              <input
                type="password"
                value={geminiKey || ''}
                onChange={(e) => handleGeminiKeyChange && handleGeminiKeyChange(e.target.value)}
                className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all"
                placeholder="AIzaSy..."
              />
            </div>
