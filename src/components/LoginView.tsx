...
export const LoginView: React.FC<LoginViewProps> = ({ onLogin }) => {
  return (
    <main className="sovereign-login-shell p-4 text-slate-100">
      <section className="mx-auto flex min-h-[calc(100dvh-2rem)] max-w-4xl flex-col justify-center rounded-3xl border border-slate-700 bg-slate-950/80 p-6 shadow-2xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-300 md:text-base">
            Starte die geschützte Arbeitsfläche für Repository-Analyse, Live-Monitor, Pattern Memory,
        ...
        <div className="mt-8 grid gap-3 text-sm md:grid-cols-3">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
            ...
            <p className="mt-1 text-xs text-slate-400">Repository-URL eintragen und echten Snapshot prüfen.</p>
          </div>
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
