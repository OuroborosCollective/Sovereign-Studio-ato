...
export function LlmAdapterProvider({
  ...
  const adapters = useMemo(
    () => buildSovereignLlmAdapters({
      primaryBridgeProxyUrl: mergedApiKeys.primaryBridgeProxyUrl,
      primaryBridgeModel: mergedApiKeys.primaryBridgeModel,
      pollinationsApiKey: mergedApiKeys.pollinations,
      groqApiKey: mergedApiKeys.groq,
      huggingfaceApiKey: mergedApiKeys.huggingface,
      togetherApiKey: mergedApiKeys.together,
      openrouterApiKey: mergedApiKeys.openrouter,
      geminiApiKey: mergedApiKeys.gemini,
      cards,
      settings,
    }),
    [
      ...
      mergedApiKeys.pollinations,
      mergedApiKeys.groq,
      mergedApiKeys.huggingface,
      mergedApiKeys.together,
      mergedApiKeys.openrouter,
