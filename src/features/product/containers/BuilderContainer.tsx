...
export function BuilderContainer({ mission, repoReady, repoReason, repoBusy, runtimeBusy, isPublishing, sovereignSummary, sovereignPreview, onMissionChange, onGenerateIdeas, onGenerateErrorWorkflow, onPublishDraftPr, openhandsReady, openhandsJob, openhandsJobStatus, openhandsIsRunning, onStartOpenHands, onCancelOpenHands }: BuilderContainerProps) {
