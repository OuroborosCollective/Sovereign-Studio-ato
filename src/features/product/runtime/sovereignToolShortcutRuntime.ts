...
export function evaluateSovereignToolShortcutGate(
  ...
  switch (definition.id) {
    ...
    case 'executor':
      ...
      return gate(definition, { canOpen: true, state: 'ready', statusLabel: 'Start möglich', reason: 'Repo, Agent-Runtime und Ausführungsauftrag sind bestätigt. GitHub-Publikation bleibt ein separates Gate.', nextAction: 'Agent-Zero-Job anfragen.' });
    case 'runtime_logs':
