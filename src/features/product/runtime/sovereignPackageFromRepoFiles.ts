...
export async function buildSovereignPackageFromRepoFilesWithLlm(
  ...
  if (llmResult.ok && llmResult.brain) {
    ...
    // Add audit artifact like the existing implementation
    ...
    // Analyze repo architecture and classify work like existing implementation
    ...
    // Build package from LLM result following the existing pattern
