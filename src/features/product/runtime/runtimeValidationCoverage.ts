...
export const RUNTIME_VALIDATION_TARGETS: RuntimeValidationTarget[] = [
  {
    ...
    status: 'covered',
    integrationPoint: 'agentWorkspaceAdapter + BuilderContainer',
  },
  {
    id: 'sovereign-agent-workspace-adapter',
    runtimePath: 'src/features/product/runtime/agentWorkspaceAdapter.ts',
    testPath: 'src/features/product/runtime/agentWorkspaceAdapter.test.ts',
    purpose: 'Routes Sovereign Agent through neutral AgentWorkspaceRuntime contract. Validates, sanitizes, normalizes. Never invents changedFiles or Draft PR URLs.',
    status: 'covered',
