...
export const SOVEREIGN_PRESET_ACTIONS: readonly SovereignPresetAction[] = [
  ...
  },
  {
    id: 'error_fix_plan',
    icon: '🛠',
    label: 'Fehler suchen & als Draft PR reparieren',
    shortLabel: 'Fehler',
    description: 'Fehlerfamilien im Repo belegen, kausal reparieren und einen prüfbaren Draft PR vorbereiten.',
    requiresRepo: true,
    requiresGithubWrite: true,
    route: 'direct_patch_or_agent',
    risk: 'reviewable_patch',
    prompt: [
      'Suche im aktuellen Repo nach belegten Fehlerquellen und repariere zuerst die kausale Fehlerfamilie.',
      'Erzeuge einen kleinen prüfbaren Patch mit Regressionstest und bereite ausschließlich einen Draft PR vor.',
      'Kein direkter Push auf main, kein Auto-Merge und keine Erfolgsmeldung ohne Diff-, Test- und Draft-PR-Evidence.',
    ].join('\n'),
  },
  {
