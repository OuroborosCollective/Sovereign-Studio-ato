                  ...
                  <div className="py-1 max-h-64 overflow-y-auto">
                    {availableModels.map((model) => (
                      <button
                        ...
                        className={`w-full px-3 py-2.5 flex items-center gap-3 hover:bg-slate-800/80 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50 focus-visible:-outline-offset-2 ${
      ...
      <div className="p-4 border-t border-cyan-500/15 bg-slate-900/50 shrink-0">
        <form onSubmit={handleSubmit} className="flex gap-2" aria-label="Send Message">
          <div className="flex-1 relative">
            ...
            {inputValue && (
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 transition-colors p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50 rounded-lg"
          ...
          <button
            ...
            aria-label={canSubmit ? "Send message" : "Enter a message to send"}
