    ...
    >
                  ...
                  <div className="py-1 max-h-64 overflow-y-auto">
                    {availableModels.map((model) => (
                      <button
                        ...
                        className={`w-full px-3 py-2.5 flex items-center gap-3 hover:bg-slate-800/80 focus-visible:bg-slate-800/80 focus-visible:outline-none transition-colors ${
      ...
      <div className="p-4 border-t border-cyan-500/15 bg-slate-900/50 shrink-0">
        ...
        <button
          type="button"
          onClick={onClearChat}
          className="w-full mt-2 py-2 text-[11px] text-slate-500 hover:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-500/50 rounded-lg flex items-center justify-center gap-2 transition-colors"
