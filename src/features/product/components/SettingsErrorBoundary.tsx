        ...
        <div className="settings-error-boundary p-6 bg-red-50 border border-red-200 rounded-xl">
          ...
          <div className="mt-4 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
            <p className="text-sm text-emerald-700">
              <strong>💡 Hinweis:</strong> Online-Modelle laufen ausschließlich über das Sovereign Backend: Paid direkt über OpenRouter und Free direkt über FreeLLM. LiteLLM ist nicht Teil der produktiven Toolchain.
            </p>
          </div>
        </div>
      );
