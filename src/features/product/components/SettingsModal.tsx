        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <div className="space-y-4">
            ...
            <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-100 text-[11px] text-emerald-900">
              🔐 Online-Modelle laufen ausschließlich über das Sovereign Backend: Paid direkt über OpenRouter, Free direkt über FreeLLM. LiteLLM ist nicht Teil der produktiven Toolchain. Provider, Preise und Evidenz werden unter /admin → LLM Routes verwaltet.
            </div>
