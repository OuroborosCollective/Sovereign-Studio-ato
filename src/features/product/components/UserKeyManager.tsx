      ...
      <div className="user-key-manager">
        <div className="key-manager-header">
          ...
          <p className="key-manager-description">
            ...
            Neue Provider werden ausschließlich unter /admin → LLM Routes vorbereitet und über die geschützte Owner-Eingabe an den passenden Direkttransport übergeben: OpenRouter für Paid, FreeLLM für Free. LiteLLM ist nicht Teil der produktiven Toolchain.
          </p>
        </div>
