...
const App: React.FC = () => {
  ...
  const publishDraftPr = async () => {
    ...
    try {
      ...
      setSovereignSummary(error instanceof Error ? error.message : 'Draft PR konnte nicht erstellt werden.');
    } finally {
    ...
    <div className="min-h-screen p-4">
      ...
      <section className="mt-4 rounded border border-slate-700 bg-slate-950/60 p-4 text-sm text-slate-200">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          <button onClick={generateRepoIdeas} disabled={actionDisabled}>Ideen</button>
          <button onClick={generateErrorWorkflow} disabled={actionDisabled}>Fehler</button>
          <button onClick={publishDraftPr} disabled={isPublishing || actionDisabled}>
