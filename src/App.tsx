        ...
        <section className="mt-4 rounded border border-slate-700 bg-slate-950/60 p-4 text-sm text-slate-200" data-testid="operator-monitor">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-400">Optionale Operator-Zentrale für Runtime Guards, Pattern Memory, Remote Memory und Telemetry. Der Release-Workflow startet bewusst im Repo-Tab.</p>
            </div>
