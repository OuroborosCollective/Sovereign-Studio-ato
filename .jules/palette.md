...
## 2024-05-24 - [Remove German text for a11y]
**Learning:** Screen reader users can get confused when languages are mixed (e.g. English UI, German `title` attribute).
**Action:** Do not mix English UI and German strings, even for title and aria labels.
