...
/**
 * CoderAgent
 * Kern-Komponente der Sovereign Studio Engine zur Umsetzung architektonischer Blueprints
...
export class CoderAgent {
  ...
  async patchNativeGradle(gradleContent, changes) {
    const prompt = `
      Patsche die folgende build.gradle Datei für Sovereign Studio (Capacitor 6 Stack).
  ...
  _buildGenerationPrompt(task, context) {
    return `
      Du bist der Sovereign Studio Design-Coder.
